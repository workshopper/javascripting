...
Luego, define una variable llamada `filtered` que referencie el resultado de `numeros.filter()`.
...
Utiliza `console.log()` para imprimir el array `filtered` a la terminal.
